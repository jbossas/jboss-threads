 ...
 * @author panos
 */
public final class JBossThreadPoolExecutorReuseIdleThreads extends AbstractExecutorService implements BlockingExecutorService, BoundedQueueThreadPoolExecutorMBean, ShutdownListenable {
...
//    private final AtomicInteger idleWorkers = new AtomicInteger();
     ...
     */
    private volatile JBossRejectedExecutionHandler handler;
     ...
     */
    private static final JBossRejectedExecutionHandler defaultHandler =
        new AbortPolicy();
...
//                idleWorkers.decrementAndGet();
     ...
     */
    public JBossThreadPoolExecutorReuseIdleThreads(int corePoolSize,
                              int maximumPoolSize,
                              long keepAliveTime,
                              TimeUnit unit,
    ...
    public JBossThreadPoolExecutorReuseIdleThreads(int corePoolSize,
                              ...
                              TimeUnit unit,
                              BlockingQueue<Runnable> workQueue,
                              JBossRejectedExecutionHandler handler) {
        this(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue,
...
/*
        if (maximumPoolSize != corePoolSize) {
            if (workerCountOf(c) < maximumPoolSize) {
                if (!existIdleWorker()) {
                    int recheck = ctl.get();
                    if (workerCountOf(recheck) < maximumPoolSize) {
     ...
     */
    public void setRejectedExecutionHandler(JBossRejectedExecutionHandler handler) {
        if (handler == null)
            throw new NullPointerException();
        this.handler = handler;
    }
     ...
     */
    public JBossRejectedExecutionHandler getRejectedExecutionHandler() {
        return handler;
    }
     ...
     */
    public static class AbortPolicy implements JBossRejectedExecutionHandler {
        /**
         ...
         */
        public void rejectedExecution(Runnable r, JBossThreadPoolExecutorReuseIdleThreads e) {
     ...
     * rejected task.
     */
    public static class DiscardPolicy implements JBossRejectedExecutionHandler {
        /**
     ...
     */
    public static class DiscardOldestPolicy implements JBossRejectedExecutionHandler {
        /**
